...
<Canvas>
  <Story name="Secondary">
    ...
    <Button buttonType="secondary" compactX data-qa-button="secondary">
      CompactX Secondary
    </Button>
    <Button buttonType="secondary" compactY data-qa-button="secondary" style={{ marginTop: 7, maxHeight: 20 }}>
      CompactY Secondary
    </Button>
...
<Canvas>
  <Story
    ...
    argTypes={{
      ...
      compactX: {
        description:
          'Removes the left and right spacing of the text for secondary buttons only.',
        table: {
      ...
      compactY: {
        description:
          'Removes the top and bottom spacing of the text for secondary buttons only.',
        table: {
          defaultValue: { summary: 'false' },
        },
      },
      disabled: {
        description:
          'A button should remain disabled until all required data has been entered in a form or data has been changed in an edit state.',
        table: {
          defaultValue: { summary: 'false' },
        },
      },
