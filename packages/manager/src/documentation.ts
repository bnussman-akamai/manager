...
export const SecurityControls: Doc = {
...
export const BillingAndPayments: Doc = {
...
export const AccountsAndPasswords: Doc = {
...
export const Images: Doc = {
  ...
  src:
    'https://linode.com/docs/platform/disk-images/linode-images-new-manager/',
};

export const StackScripts: Doc = {
...
export const BlockStorage: Doc = {
  title: 'How to Use Block Storage with Your Linode',
  body:
    'Linode’s Block Storage service allows you to attach additional storage volumes to your Linode. A single volume can range from 10 GB to 10,000 GB in size and costs $0.10/GB per month. They can be partitioned however you like and can accommodate any filesystem type you choose. Up to eight volumes can be attached to a single Linode, be it new or already existing, so you do not need to recreate your server to add a Block Storage Volume.',
  src:
    'https://linode.com/docs/platform/block-storage/how-to-use-block-storage-with-your-linode-new-manager/',
};

export const MonitoringYourServer: Doc = {
...
export const NodeBalancerReference: Doc = {
...
export const NodeBalancerGettingStarted: Doc = {
...
export const LinodeGettingStarted: Doc = {
...
export const SecuringYourServer: Doc = {
...
export const AppsDocs: Doc[] = [
  {
    ...
    body:
      'Create Custom Instances and Automate Deployment with One-Click Apps.',
  },
  {
