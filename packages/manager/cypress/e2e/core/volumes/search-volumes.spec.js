...
describe('Search Volumes', function () {
    before(function () {
     ...
     */
    it('creates two volumes and make sure they show up in the table and are searchable', function () {
        var createTwoVolumes = function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.all([
                        (0, volumes_1.createVolume)({
        ...
        cy.defer(function () { return createTwoVolumes(); }, 'creating volumes').then(function (_a) {
            var volume1 = _a[0], volume2 = _a[1];
            ...
            ui_1.ui.mainSearch.find().type(volume2.label);
            ui_1.ui.autocompletePopper.findByTitle(volume2.label).click();
