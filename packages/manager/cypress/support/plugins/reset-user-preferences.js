...
exports.resetUserPreferences = void 0;
var api_v4_1 = require("@linode/api-v4");
var envVarName = 'CY_TEST_RESET_PREFERENCES';
/**
 * Resets test account user preferences to expected state when
 * `CY_TEST_RESET_PREFERENCES` is set.
 */
var resetUserPreferences = function (_on, config) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!config.env[envVarName]) return [3 /*break*/, 2];
                return [4 /*yield*/, (0, api_v4_1.updateUserPreferences)({
