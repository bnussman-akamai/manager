...
exports.createActiveVolume = exports.deleteAllTestVolumes = void 0;
 ...
 */
var deleteAllTestVolumes = function () { return __awaiter(void 0, void 0, void 0, function () {
    var volumes, detachDeletePromises;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, paginate_1.depaginate)(function (page) {
                    return (0, api_v4_1.getVolumes)({ page: page, page_size: api_1.pageSize });
                })];
            case 1:
                volumes = _a.sent();
                detachDeletePromises = volumes
                    .filter(function (volume) {
                    return (0, common_1.isTestLabel)(volume.label) && volume.status === 'active';
                })
                    .map(function (volume) { return __awaiter(void 0, void 0, void 0, function () {
                    var backoff;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!volume.linode_id) return [3 /*break*/, 2];
                                return [4 /*yield*/, (0, api_v4_1.detachVolume)(volume.id)];
                            case 1:
                                _a.sent();
                                _a.label = 2;
                            case 2:
                                backoff = new backoff_1.SimpleBackoffMethod(10000, {
                                    maxAttempts: 10,
                                });
                                return [4 /*yield*/, (0, backoff_1.attemptWithBackoff)(backoff, function () { return (0, api_v4_1.deleteVolume)(volume.id); })];
                            case 3:
                                _a.sent();
                                return [2 /*return*/];
                        }
                ...
                return [4 /*yield*/, Promise.all(detachDeletePromises)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
exports.deleteAllTestVolumes = deleteAllTestVolumes;
/**
...
exports.createActiveVolume = createActiveVolume;
