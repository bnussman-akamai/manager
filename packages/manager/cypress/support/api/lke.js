...
exports.deleteAllTestLkeClusters = void 0;
 ...
 */
var deleteAllTestLkeClusters = function () { return __awaiter(void 0, void 0, void 0, function () {
    var clusters, clusterDeletionPromises;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, paginate_1.depaginate)(function (page) {
                    return (0, api_v4_1.getKubernetesClusters)({ page: page, page_size: api_1.pageSize });
                })];
            case 1:
                clusters = _a.sent();
                clusterDeletionPromises = clusters
                    .filter(function (cluster) { return (0, common_1.isTestLabel)(cluster.label); })
                        ...
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, (0, paginate_1.depaginate)(function (page) {
                                        return (0, api_v4_1.getNodePools)(cluster.id, { page: page, page_size: api_1.pageSize });
                                    })];
                            case 1:
                                pools = _a.sent();
...
exports.deleteAllTestLkeClusters = deleteAllTestLkeClusters;
