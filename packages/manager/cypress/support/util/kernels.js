...
exports.findKernelById = exports.fetchAllKernels = void 0;
 ...
 */
var fetchAllKernels = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, (0, paginate_1.depaginate)(function (page) {
                return (0, api_v4_1.getLinodeKernels)({ page: page, page_size: api_1.pageSize });
            })];
    });
}); };
exports.fetchAllKernels = fetchAllKernels;
/**
 ...
 */
var findKernelById = function (kernels, kernelId) {
    var kernel = kernels.find(function (kernel) { return kernel.id === kernelId; });
    if (!kernel) {
        throw new Error("Unable to find a Linode kernel with ID '".concat(kernelId, "'"));
    }
    return kernel;
};
